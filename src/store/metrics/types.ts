...
export interface Owner extends ApiResponse {
  login: string
  id: number
  node_id: string
  avatar_url: string
...
// Participation Stats
export interface Stats extends ApiResponse {
  all: number[]
  owner: number[]
}

export interface StatRequestPayload {
  username: string
  repo_name: string
}
...
export const enum MetricsActionTypes {
  ...
  LOAD_STATS_SUCCESS = '@@metrics/LOAD_STATS_SUCCESS',
